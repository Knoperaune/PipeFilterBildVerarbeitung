...
/**
 * Thanks Michael Faißt & Florian Fink for the help
 *
 * @author phil
 */
public class CentroidProcessor extends GenericProcessor<PlanarImage, PlanarImage> {
    ...
    /**
     * Cuts the ROIs out of the Image
     *
     * @param image
     */
    private void getROIs(PlanarImage image) {
    ...
    /**
     * creates the Rectangles of the ROI
     */
    private void createROIRecs() {
        for (int i = 0; i < rois.size(); i++) {
            ...
            centroids.add(new Point(mittelwertX + roisRect.get(i).x,
                    mittelwertY + roisRect.get(i).y));
        }
    }
